...
IA_JAN_MODEL = os.environ.get("IA_JAN_MODEL", "gemma-4-E2B-it-IQ4_XS")
IA_JAN_API_KEY = os.environ.get("IA_JAN_API_KEY", "")
IA_JAN_EXTRA_BODY = os.environ.get("IA_JAN_EXTRA_BODY", "{}")
IA_REQUEST_TIMEOUT = float(os.environ.get("IA_REQUEST_TIMEOUT", "60"))
IA_MAX_TOKENS = int(os.environ.get("IA_MAX_TOKENS", "900"))
